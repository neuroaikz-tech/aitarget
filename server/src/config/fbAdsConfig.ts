    ...
    OUTCOME_TRAFFIC: {
        ...
        destination_configs: {
            ...
            WHATSAPP: {
                ...
                call_to_actions: ['WHATSAPP_MESSAGE', 'CONTACT_US'],
                default_call_to_action: 'WHATSAPP_MESSAGE',
            ...
            INSTAGRAM_DIRECT: {
                ...
                call_to_actions: ['INSTAGRAM_MESSAGE', 'CONTACT_US'],
                default_call_to_action: 'INSTAGRAM_MESSAGE',
                requires_website_url: false,
                requires_whatsapp_phone: false,
            ...
            MESSENGER: {
                ...
                billing_event: 'IMPRESSIONS',
                allow_cost_cap: false,
                call_to_actions: ['MESSAGE_PAGE', 'CONTACT_US'],
                default_call_to_action: 'MESSAGE_PAGE',
                requires_website_url: false,
                requires_whatsapp_phone: false,
                requires_instagram_actor: false,
            },
    ...
    OUTCOME_ENGAGEMENT: {
        ...
        destination_configs: {
            ...
            WHATSAPP: {
                ...
                billing_event: 'IMPRESSIONS',
                allow_cost_cap: false,
                call_to_actions: ['WHATSAPP_MESSAGE'],
                default_call_to_action: 'WHATSAPP_MESSAGE',
                requires_website_url: false,
                requires_whatsapp_phone: true,
                requires_instagram_actor: false,
            ...
            INSTAGRAM_DIRECT: {
                ...
                billing_event: 'IMPRESSIONS',
                allow_cost_cap: false,
                call_to_actions: ['INSTAGRAM_MESSAGE'],
                default_call_to_action: 'INSTAGRAM_MESSAGE',
                requires_website_url: false,
                requires_whatsapp_phone: false,
                requires_instagram_actor: true,
    ...
    OUTCOME_LEADS: {
        ...
        destination_configs: {
            ...
            WHATSAPP: {
                ...
                billing_event: 'IMPRESSIONS',
                allow_cost_cap: false,
                call_to_actions: ['WHATSAPP_MESSAGE', 'GET_QUOTE'],
                default_call_to_action: 'WHATSAPP_MESSAGE',
                requires_website_url: false,
                requires_whatsapp_phone: true,
                requires_instagram_actor: false,
            ...
            MESSENGER: {
                ...
                billing_event: 'IMPRESSIONS',
                allow_cost_cap: false,
                call_to_actions: ['MESSAGE_PAGE', 'GET_QUOTE'],
                default_call_to_action: 'MESSAGE_PAGE',
                requires_website_url: false,
                requires_whatsapp_phone: false,
                requires_instagram_actor: false,
    ...
    OUTCOME_SALES: {
        ...
        destination_configs: {
            ...
            WHATSAPP: {
                ...
                billing_event: 'IMPRESSIONS',
                allow_cost_cap: false,
                call_to_actions: ['WHATSAPP_MESSAGE', 'ORDER_NOW', 'SHOP_NOW'],
                default_call_to_action: 'WHATSAPP_MESSAGE',
                requires_website_url: false,
                requires_whatsapp_phone: true,
                requires_instagram_actor: false,
            ...
            MESSENGER: {
                ...
                billing_event: 'IMPRESSIONS',
                allow_cost_cap: false,
                call_to_actions: ['MESSAGE_PAGE', 'ORDER_NOW', 'SHOP_NOW'],
                default_call_to_action: 'MESSAGE_PAGE',
                requires_website_url: false,
                requires_whatsapp_phone: false,
                requires_instagram_actor: false,
...
export const CTA_LABELS: Record<FbCallToAction, string> = {
    ...
    MESSAGE_PAGE: 'Написать в Messenger',
